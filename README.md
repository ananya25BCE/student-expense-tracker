# Student Spending Monitor ##
Summary  A straightforward Python command-line program that assists students in keeping tabs on their daily spending.  The application lets users: - Add an expense; - View all expenses; - Determine total spending; - Automatically save and load expense data.
